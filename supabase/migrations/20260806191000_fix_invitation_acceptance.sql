...
begin
  ...
  from public.space_invitations as invitation_row
  ...
  on conflict on constraint space_members_pkey do update set
  ...
  update public.space_invitations as invitation_row
